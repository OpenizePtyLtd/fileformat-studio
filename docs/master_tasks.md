...
| **TASK-20** | [#46](https://github.com/OpenizePtyLtd/fileformat-studio/issues/46) | 9. Benchmark & Comparison | `feat(benchmark): Design Document Category & Format Registry with IBenchmarkMetric abstraction` | M4 | None | ⏳ Pending |
| **TASK-21** | [#47](https://github.com/OpenizePtyLtd/fileformat-studio/issues/47) | 9. Benchmark & Comparison | `feat(data): Implement EF Core entities and migrations for Benchmark sessions, runs, and metric results` | M4 | TASK-20 | ⏳ Pending |
| **TASK-22** | [#48](https://github.com/OpenizePtyLtd/fileformat-studio/issues/48) | 9. Benchmark & Comparison | `feat(benchmark): Implement BenchmarkRunnerService for multi-parser parallel execution and scoring engine` | M4 | TASK-20, TASK-21 | ⏳ Pending |
| **TASK-23** | [#49](https://github.com/OpenizePtyLtd/fileformat-studio/issues/49) | 9. Benchmark & Comparison | `feat(benchmark): Implement Core Benchmark Metrics (Character Count, Speed, Memory, Text Cleanliness)` | M4 | TASK-20 | ⏳ Pending |
| **TASK-24** | [#50](https://github.com/OpenizePtyLtd/fileformat-studio/issues/50) | 9. Benchmark & Comparison | `feat(ui): Build BenchmarkPage with Category & Format filter and document upload runner` | M4 | TASK-20, TASK-22 | ⏳ Pending |
| **TASK-25** | [#51](https://github.com/OpenizePtyLtd/fileformat-studio/issues/51) | 9. Benchmark & Comparison | `feat(ui): Implement Benchmark Results Comparison Matrix and Winner Scorecard` | M4 | TASK-22, TASK-23, TASK-24 | ⏳ Pending |
